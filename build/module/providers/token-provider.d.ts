...
export declare const USDT_BSC_TESTNET: Token;
export declare const USDC_BSC_TESTNET: Token;
export declare const BTCB_BSC_TESTNET: Token;
export declare const DAI_BSC_TESTNET: Token;
