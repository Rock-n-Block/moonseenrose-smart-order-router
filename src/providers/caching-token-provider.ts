...
import {
  ...
  DAI_BSC_TESTNET,
  DAI_CELO,
  DAI_CELO_ALFAJORES, DAI_MAINNET,
  DAI_MOONBASE_ALPHA,
  DAI_MOONBEAM,
  DAI_OPTIMISM,
  DAI_OPTIMISM_GOERLI,
  ...
  USDC_BSC,
  USDC_BSC_TESTNET,
  USDC_ETHEREUM_GNOSIS, USDC_MAINNET,
  USDC_MOONBASE_ALPHA,
  USDC_MOONBEAM,
  USDC_OPTIMISM,
  ...
  USDT_BSC,
  USDT_BSC_TESTNET, USDT_MAINNET,
  USDT_MOONBASE_ALPHA,
  USDT_OPTIMISM,
  USDT_OPTIMISM_GOERLI,
  USDT_OPTIMISTIC_KOVAN,
  WBTC_ARBITRUM, WBTC_MAINNET,
  WBTC_MOONBASE_ALPHA,
  WBTC_MOONBEAM,
  WBTC_OPTIMISM,
...
export const CACHE_SEED_TOKENS: {
  ...
  [ChainId.BSC_TESTNET]: {
    USDC: USDC_BSC_TESTNET,
    USDT: USDT_BSC_TESTNET,
    DAI: DAI_BSC_TESTNET,
    BTCB: BTCB_BSC_TESTNET,
    WBNB: WRAPPED_NATIVE_CURRENCY[ChainId.BSC_TESTNET],
  },
