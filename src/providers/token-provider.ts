...
// BNB Testnet chain Tokens
export const USDT_BSC_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x6D488c820A58c9867D1a2BdfC1787A4090E92E69',
  18,
  'USDT',
  'USDT',
);
...
export const USDC_BSC_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x737a644c9120bB0E3d549AA93Cfce40C42d9E7Aa',
  6,
  'USDC',
  'USDC',
);

export const BTCB_BSC_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x0c12207ABd905f40045DF836DE14Cf6f3b80327f',
  18,
  'BTCB',
  'BTCB',
);
...
export const DAI_BSC_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0xac5029341Ac169fc63F8d610E9e6976E9d3AfC8E',
  18,
  'DAI',
  'DAI',
);
